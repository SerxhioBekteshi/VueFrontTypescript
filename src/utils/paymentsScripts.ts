...
export async function retriveuserinformation(subscriptionID: any) {
...
export async function suspendusersubscription(subscriptionID: any) {
  // 1. Call PayPal to get a token
  const auth = await axios({
    url: "https://api-m.sandbox.paypal.com/v1/oauth2/token",
    method: "post",
...
// suspend user subscription
export async function cancelusersubscription(subscriptionID: any) {
  // 1. Call PayPal to get a token
  const auth = await axios({
    url: "https://api-m.sandbox.paypal.com/v1/oauth2/token",
    method: "post",
...
export async function activateusersubscription(subscriptionID: any) {
  // 1. Call PayPal to get a token
  const auth = await axios({
    url: "https://api-m.sandbox.paypal.com/v1/oauth2/token",
    method: "post",
